...
def parse_args():
    ...
    module_group.add_argument(
        ...
        help="A demo of fibermorph curvature with dummy data. Arcs and lines are generated, analyzed and error is calculated.")

    module_group.add_argument(
        "--demo_dummy_section", action="store_true", default=False,
        help="A demo of fibermorph section with dummy data. Circles and ellipses are generated, analyzed and error is calculated.")
